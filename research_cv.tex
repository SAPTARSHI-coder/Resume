...
%	Copyright (c) 2026 Saptarshi Sadhu. All Rights Reserved.
%	Unauthorized plagiarism, impersonation, or commercial reproduction is prohibited.
%----------------------------------------------------------------------------------------
...
\usepackage[pdftex,
    ...
    pdfsubject={Academic Research CV - Copyright 2026 Saptarshi Sadhu},
    pdfkeywords={Saptarshi Sadhu, Academic CV, Research, Artificial Intelligence, Machine Learning},
...
\begin{minipage}[t]{0.17\textwidth}
    \raggedleft
    \fboxsep=0pt
    \color{cvgray}\fbox{\includegraphics[width=64pt,height=76pt,keepaspectratio]{picture.jpg}}
\end{minipage}
